...
attribs:
        ...
        defw      race_raster + (0 * 8 * 41)

        defw      race_raster + (1 * 8 * 41)

        defw      race_raster + (2 * 8 * 41)

        defw      race_raster + (3 * 8 * 41)

        defw      race_raster + (4 * 8 * 41)

        defw      race_raster + (5 * 8 * 41)

        defw      race_raster + (6 * 8 * 41)

        defw      race_raster + (7 * 8 * 41)

        defw      race_raster + (8 * 8 * 41)

        defw      race_raster + (9 * 8 * 41)

        defw      race_raster + (10 * 8 * 41)

        defw      race_raster + (11 * 8 * 41)

        defw      race_raster + (12 * 8 * 41)

        defw      race_raster + (13 * 8 * 41)

        defw      race_raster + (14 * 8 * 41)

        defw      race_raster + (15 * 8 * 41)

        defw      race_raster + (16 * 8 * 41)

        defw      race_raster + (17 * 8 * 41)
